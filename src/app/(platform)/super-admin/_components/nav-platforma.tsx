          ...
          return (
            <li key={href}>
              <Link
                ...
                className={`focus-visible:ring-ring flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition focus-visible:ring-2 focus-visible:outline-none ${
                  activ
