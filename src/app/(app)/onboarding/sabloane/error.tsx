// src/app/(app)/onboarding/sabloane/error.tsx
"use client";

import { useEffect } from "react";
import { TriangleAlert } from "lucide-react";

export default function EroareSabloane({
  error,
  retry,
}: {
  ...
  useEffect(() => {
    console.error("[onboarding/sabloane] eroare de randare", error);
  }, [error]);
    ...
    <main className="mx-auto w-full max-w-3xl p-4 sm:p-6">
      <div className="border-border bg-surface rounded-lg border p-8 text-center">
        ...
        <h1 className="text-foreground mt-3 text-lg font-semibold">
          Șabloanele nu au putut fi afișate
        </h1>
