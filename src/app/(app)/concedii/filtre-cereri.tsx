    ...
    >
      ...
      <div className="min-w-48">
        ...
        <select
          ...
          className="mt-1 w-full rounded-md border border-zinc-300 px-2 py-2 text-sm dark:border-zinc-600 dark:bg-zinc-900"
        >
          <option value="">Toate</option>
          {tipuri.map((tip) => (
      ...
      <button
        type="submit"
        disabled={inCurs}
        className="inline-flex items-center gap-2 rounded-md bg-zinc-900 px-4 py-2 text-sm font-medium text-white disabled:opacity-60 dark:bg-zinc-100 dark:text-zinc-900"
      >
