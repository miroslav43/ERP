// src/app/(app)/diurna/politica/error.tsx
"use client";

import { useEffect } from "react";
import { TriangleAlert } from "lucide-react";

export default function EroarePolitica({
  error,
  retry,
}: {
  ...
  useEffect(() => {
    console.error("[diurna/politica] eroare de randare", error);
  }, [error]);
  ...
  return (
    <main className="mx-auto w-full max-w-3xl p-4 sm:p-6">
      <div className="border-border bg-surface rounded-lg border p-8 text-center">
        ...
        <h1 className="text-foreground mt-3 text-lg font-semibold">Politica de diurnă nu a putut fi afișată</h1>
