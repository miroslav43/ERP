...
export default function EroareDiurna({
  error,
  retry,
}: {
  ...
  useEffect(() => {
    console.error("[diurna] eroare de randare", error);
  }, [error]);
  ...
  return (
    <main className="mx-auto w-full max-w-3xl p-4 sm:p-6">
      <div className="border-border bg-surface rounded-lg border p-8 text-center">
        ...
        <h1 className="text-foreground mt-3 text-lg font-semibold">Deplasările nu au putut fi afișate</h1>
