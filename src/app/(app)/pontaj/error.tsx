...
export default function EroarePontaj({
  error,
  retry,
}: {
  ...
  useEffect(() => {
    console.error("[pontaj] eroare de randare", error);
  }, [error]);
  ...
  return (
    <main className="mx-auto w-full max-w-3xl p-4 sm:p-6">
      <div className="border-border bg-surface rounded-lg border p-8 text-center">
        ...
        <h1 className="text-foreground mt-3 text-lg font-semibold">Pontajul nu a putut fi afișat</h1>
