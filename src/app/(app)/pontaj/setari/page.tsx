  ...
  return (
    <main className="max-w-3xl space-y-6 p-6">
      <header>
        ...
        <h1 className="text-2xl font-semibold">Setări pontaj</h1>
      </header>
      ...
      {istoric.length <= 1 ? null : (
        <section aria-label="Versiuni anterioare" className="border-border rounded-lg border p-4">
          <h2 className="mb-2 text-sm font-medium">Versiuni</h2>
