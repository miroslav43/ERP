...
// Codurile de zi stau acum în `src/domain/attendance/coduri-zi.ts`: le folosește
// și generatorul de Excel al arhivei, iar `src/lib/` n-are voie să importe din
// arborele de rute. Reexportate aici ca să nu se schimbe niciun consumator.
export { CODURI_TIP_ZI } from "@/domain/attendance/coduri-zi";
